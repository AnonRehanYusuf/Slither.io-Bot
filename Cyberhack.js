/*
/***************************************************************************/
/*            Agar/Slither Cyber Hacker is created by Rehan Yusuf             */
/***************************************************************************/
*/
...
var userInterface = window.userInterface = (function() {
    ...
    return {
        ...
        onPrefChange: function() {
			...
			oContent.push('_________________________________');
            oContent.push('|CyberHack: ' + GM_info.script.version);
			oContent.push('|Cyber Hacker Menu Bot');
			oContent.push('|Web:hacker-cyberhack.blogspot.sg');
            ...
            oContent.push('|    By Credits     ');
			oContent.push('|    Rehan Yusuf  ');
            oContent.push('|_________________________________');
